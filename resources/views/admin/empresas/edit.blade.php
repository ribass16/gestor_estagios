            ...
            <form method="POST" action="{{ route('admin.empresas.update', $empresa) }}">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input name="responsavel_email"
                                   value="{{ old('responsavel_email', $empresa->responsavel_email ?? ($empresa->user->email ?? '')) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm text-gray-300">Nova password (opcional)</label>
                ...
                <div class="space-y-4 pt-6 border-t border-gray-800">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="nome" value="{{ old('nome', $empresa->nome) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                        ...
                        <div>
                            ...
                            <input name="nif" value="{{ old('nif', $empresa->nif) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="email_contacto" value="{{ old('email_contacto', $empresa->email_contacto) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                        ...
                        <div>
                            ...
                            <input name="telemovel" value="{{ old('telemovel', $empresa->telemovel) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="website" value="{{ old('website', $empresa->website) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                        ...
                        <div>
                            ...
                            <input name="setor" value="{{ old('setor', $empresa->setor) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                    ...
                    <div>
                        ...
                        <input name="morada" value="{{ old('morada', $empresa->morada) }}"
                               class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="descricao" rows="3"
                                  class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded">{{ old('descricao', $empresa->descricao) }}</textarea>
                    </div>

                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" name="aceita_estagios" value="1"
                               {{ old('aceita_estagios', $empresa->aceita_estagios) ? 'checked' : '' }}
                ...
                <div class="space-y-4 pt-6 border-t border-gray-800">
                    ...
                    <div class="grid sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input name="responsavel_telemovel"
                                   value="{{ old('responsavel_telemovel', $empresa->responsavel_telemovel) }}"
                                   class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                ...
                <div class="space-y-2 pt-6 border-t border-gray-800">
                    ...
                    <select name="estado" class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded">
                        @php $estado = old('estado', $empresa->estado); @endphp
                        <option value="pendente"  {{ $estado==='pendente'  ? 'selected' : '' }}>pendente</option>
                        <option value="aprovada"  {{ in_array($estado, ['aprovada','aprovado']) ? 'selected' : '' }}>aprovada</option>
                        <option value="rejeitada" {{ $estado==='rejeitada' ? 'selected' : '' }}>rejeitada</option>
                    </select>
