<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-200 leading-tight">Editar Aluno</h2>
    </x-slot>
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-lg p-6 space-y-4">
            <form method="POST" action="{{ route('admin.alunos.update', $aluno) }}">
                ...
                <div>
                    ...
                    <input name="nome" value="{{ old('nome', $aluno->user->name ?? '') }}"
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="email" value="{{ old('email', $aluno->user->email ?? '') }}"
                               class="w-full bg-gray-800 border-gray-700 text-gray-200 rounded"/>
                ...
                <div class="flex gap-3 pt-4">
                    <a href="{{ route('admin.alunos.index') }}" class="px-4 py-2 rounded bg-gray-700 text-white">Voltar</a>
